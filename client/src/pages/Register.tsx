...
import { ArrowRight, Loader2, User, Mail, Lock, Eye, EyeOff, Apple } from 'lucide-react';
        ...
        <div className="auth-card">
          <div className="auth-header">
            <motion.div
              ...
              className="auth-logo auth-logo-green"
            >
              ♔
            </motion.div>
            <h2 className="auth-title">Create Account</h2>
            <p className="auth-subtitle">Join thousands of chess players around the world.</p>
          </div>
          ...
          >
            <motion.div variants={itemVariants} className="auth-form-group">
              ...
              <div className="auth-input-wrapper">
                ...
                <input
                  ...
                  className="auth-input auth-input-green with-icon"
            ...
            <motion.button
              ...
              type="submit"
              disabled={isLoading}
              className="auth-submit-btn auth-submit-btn-green group"
            >
          ...
          <div className="auth-footer">
            ...
            <div className="auth-social-login">
              ...
              <button className="auth-social-btn" type="button" aria-label="Sign up with Apple"><Apple size={20} /></button>
            </div>
            <p className="auth-footer-text">
              Already have an account?
              <Link to="/login" className="auth-footer-link auth-footer-link-green group">
                Sign In
