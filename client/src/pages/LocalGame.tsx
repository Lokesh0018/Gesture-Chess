...
import { RotateCcw, RefreshCw, Flag, Trophy, User, Hourglass, Download, Handshake, Volume2, VolumeX, Palette, Target, Zap } from 'lucide-react';
    ...
    <div className="game-grid">
      ...
      <div className="column-center">
        ...
        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', width: '100%', maxWidth: '800px', margin: '0 auto', gap: '16px', flex: 1, minHeight: 0 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '70px', gap: '4px', flexShrink: 0, alignSelf: 'flex-start', marginTop: '16px' }}>
            <span style={{ fontSize: '12px', color: 'var(--text-secondary)', fontWeight: 500, textAlign: 'center' }}>White<br/>Pieces</span>
            {material.b > 0 && <span style={{ color: 'var(--color-success)', fontSize: '14px', fontWeight: 'bold' }}>+{material.b}</span>}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, auto)', gap: '2px', justifyContent: 'center', marginTop: '8px' }}>
              {capturedByBlack.map((p, i) => <div key={`w-${i}`} style={{ transform: 'scale(0.8)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><PieceIcon type={p} color="w" /></div>)}
            </div>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '70px', gap: '4px', flexShrink: 0, alignSelf: 'flex-start', marginTop: '16px' }}>
            <span style={{ fontSize: '12px', color: 'var(--text-secondary)', fontWeight: 500, textAlign: 'center' }}>Black<br/>Pieces</span>
            {material.w > 0 && <span style={{ color: 'var(--color-success)', fontSize: '14px', fontWeight: 'bold' }}>+{material.w}</span>}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, auto)', gap: '2px', justifyContent: 'center', marginTop: '8px' }}>
              {capturedByWhite.map((p, i) => <div key={`b-${i}`} style={{ transform: 'scale(0.8)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><PieceIcon type={p} color="b" /></div>)}
            </div>
          </div>
        ...
        <div className="card controls-card" style={{ marginTop: 'auto', flex: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ padding: '16px', flex: 1, display: 'flex', flexDirection: 'column' }}>
            <div className="controls-container" style={{ flex: 1, justifyContent: 'space-evenly' }}>
              ...
              <div className="controls-row" style={{ gridTemplateColumns: 'repeat(2, 1fr)' }}>
                <div className="control-btn" style={{ position: 'relative', cursor: 'pointer', display: 'flex', gap: '8px', padding: '0 16px', justifyContent: 'space-between' }} onClick={() => setThemeDropdownOpen(!themeDropdownOpen)}>
